...
export default {
    ...
    setup(props, context)
    {
        ...
        const btnUpdate = computed(() => {return permissions.includes(`${props.permission}.update`)})
        const btnDelete = computed(() => {return permissions.includes(`${props.permission}.delete`)})
        const load = (data) => {
