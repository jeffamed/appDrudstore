                            ...
                            <table class="tabla">
                                ...
                                <tbody style="border-bottom: 1px solid">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 11px" class="center">{{number_format($detail->discount, 2)}}</td>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td colspan="3" style="text-align: right; padding-right: 25px; border-bottom: 0px">IVA</td>
                                        <td class="center" style="font-size: 11px; border-bottom: 0px">$ {{$sale->iva}}</td>
                                    </tr>
